...
import { StructureView } from "./pages/OrganizationPage/components/StructureView";
import { ChangesView } from "./pages/OrganizationPage/components/ChangesView";
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      <Route path="/" element={<RedirectWithSearch to="/executive-branch/structure" />} />
      <Route path="docs" element={<DocsPage />} />

      <Route element={<DataLoadingAnimatedComponent />}>
        <Route element={<HomePage />}>
          <Route path="executive-branch" element={<Organization />}>
            <Route index element={<RedirectWithSearch to="/executive-branch/structure" />} />
